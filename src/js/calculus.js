...
function getSpaceCoordX(pPosition) {
    ...
    if(pPosition === 2 || pPosition === 5 || pPosition === 8) {
        return coodsGeneral.spaceBetweenBars + coodsGeneral.marginBorders + coodsGeneral.widthRectBoard;
    }
    if(pPosition === 3 || pPosition === 6 || pPosition === 9) {
        return (coodsGeneral.spaceBetweenBars * 2) + coodsGeneral.marginBorders + (coodsGeneral.widthRectBoard * 2);
    }
    return 0;
}
...
function getSpaceCoordY(pPosition) {
    ...
    if(pPosition === 4 || pPosition === 5 || pPosition === 6) {
        return coodsGeneral.spaceBetweenBars + coodsGeneral.marginBorders + coodsGeneral.widthRectBoard;
    }
    if(pPosition === 7 || pPosition === 8 || pPosition === 9) {
        return (coodsGeneral.spaceBetweenBars * 2) + coodsGeneral.marginBorders + (coodsGeneral.widthRectBoard * 2);
    }
    return 0;
}
